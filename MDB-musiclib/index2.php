...
<body>
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
      <a class="navbar-brand" href="index2.php"><img src="https://img.icons8.com/nolan/64/000000/musical-notes.png"
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item active nav-link" style="color: #fff;margin-right: 10px;margin-top: 1px;">
            <?php echo 'Welcome ,'.$_SESSION['name1']; ?>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="logout2.php">Logout<span
